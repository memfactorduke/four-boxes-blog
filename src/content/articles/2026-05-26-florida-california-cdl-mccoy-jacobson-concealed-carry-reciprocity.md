...
cases_discussed:
  - name: "Florida v. California"
    citation: "No. 22O162 (U.S. 2026)"
    court: "Supreme Court of the United States"
  - name: "McCoy v. Jacobson"
    court: "U.S. Court of Appeals for the Eighth Circuit"
court_level: ["Supreme Court", "Court of Appeals"]
circuits: ["Eighth Circuit"]
states: ["Florida", "California", "Washington", "Minnesota", "Georgia"]
federal: true
legal_topics: ["second-amendment", "concealed-carry", "interstate-reciprocity", "original-jurisdiction", "commercial-drivers-licenses"]
case_status: ["decided"]
content_type: ["news-analysis"]
tags: ["Concealed Carry", "Nationwide Reciprocity", "Clarence Thomas", "Samuel Alito", "CDL", "A Fortiori", "Harjinder Singh", "Minnesota", "Bruen"]
pull_quote: "If a red state must honor commercial driver's licenses that California and Washington handed to foreigners who can't read a stop sign, then a blue state must honor a Florida carry permit held by an American citizen exercising a textual constitutional right. A fortiori — what is true for the greater is true for the lesser."
image_prompt: "A solitary long-haul tractor-trailer on an empty multi-lane interstate at blue hour, seen from a low roadside angle as it recedes toward the horizon, red tail-lights streaking in a long exposure. Wide establishing shot across flat open plains under a deep indigo sky with one band of fading amber on the horizon. Cool blue and warm amber palette, cinematic documentary photography, quiet contemplative mood, shallow foreground focus on the rumble-strip asphalt."
---
