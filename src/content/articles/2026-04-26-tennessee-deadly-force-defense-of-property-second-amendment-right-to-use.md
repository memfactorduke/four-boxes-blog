...
cases_discussed:
  - name: "R v. Martin (Anthony)"
    citation: "[2001] EWCA Crim 2245"
    court: "Court of Appeal of England and Wales (Criminal Division)"
legal_topics:
  - "second-amendment"
  - "self-defense"
  - "defense-of-property"
...
content_type:
  - "legal-analysis"
  - "policy-analysis"
pull_quote: "A right to keep and bear arms that excludes the right to use them is a glorified hammer."
image_prompt: "The Tennessee State Capitol's limestone facade at dusk, shot from a low angle on the lawn looking up past a bare oak branch toward the Greek Revival columns and central tower, blue-hour sky bleeding from cobalt to deep amber behind the building, sodium pathway lamps casting pools of warm light across the stone steps. Atmospheric architectural photography, painterly contrast between cool sky and warm stone, deep shadows along the colonnade, palette of slate blue, weathered limestone gray, and burnished gold."
---
